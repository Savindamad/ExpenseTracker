            ...
            <View key={key}>
                <View style={[common.fd_r, common.pv_10]}>
                    <View style={[{ flex: 2 }, common.ai_c]}>
                        <Progress.Circle size={100} progress={summary.percentage} indeterminate={false}
                            showsText={true} color={summary.chartColor}
                            formatText={() => (summary.percentage * 100).toFixed(1) + '%'} />
                    </View>
                    <View style={{ flex: 3 }}>
                        <View style={[common.fd_r, common.mb_5]}>
                            <Icon style={common.mr_5} name={summary.icon} size={20} />
                            <Text style={[common.fs_l, { fontWeight: "bold" }]}>{summary.name}</Text>
                        </View>
                        ...
                        <View style={[common.fd_r, common.mt_5]}>
                            ...
                            <Text style={{ flex: 1 }}>: ${summary.spentAmount}</Text>
                        </View>
                        <View style={[common.fd_r, common.mt_5]}>
                            <Text style={{ flex: 2 }}>Available amount</Text>
                            <Text style={{ flex: 1 }}>: ${summary.availableOrOverdueAmount}</Text>
                        </View>
                    </View>
                </View>
                <View
                ...
                {props.navigationState.routes.map((route, i) => {
                    ...
                    return (
                        <TouchableOpacity key={i}
                            ...
                            onPress={() => setIndex(i)}>
                            <Animated.Text style={{ opacity, borderBottomWidth }}>{route.title}</Animated.Text>
                        </TouchableOpacity>
                    );
                })}
            </View>
