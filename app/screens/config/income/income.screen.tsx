...
export const Income = ({ navigation }) => {
    return (
        <Stack.Navigator>
            <Stack.Screen name="ListIncome" component={ListIncome}
                options={{
                    headerLeft: () => (
                    ...
                    headerTitle: 'Income',
                    headerRight: () => (
                        <Pressable onPress={() => navigation.navigate("AddEditIncome")}>
                            <Icon name="plus-circle-outline" size={30} />
                        </Pressable>
                    ),
                }} />
            <Stack.Screen name="AddEditIncome" component={AddEditIncome}
                options={{
                    headerLeft: () => (
                        <Pressable onPress={() => navigation.navigate("ListIncome")}>
                            <Icon name="chevron-left" size={40} />
                        </Pressable>
                    ),
                    title: 'Add income'
