...
export const AddEditIncome = ({ navigation }) => {
            ...
            txn.executeSql(
                ...
                (tx, res) => {
                    ...
                    for (let i = 0; i < res.rows.length; i++) {
                        ...
                        incomeTypes.push({ key: item.id, label: item.name, value: item.id })
                    }
    ...
    return (
        <View style={common.bc_white}>
            <View>
                <Text style={common.label}>Income<Text style={common.c_red}>*</Text>
                </Text>
                <TextInput style={[common.input, common.mh_10, common.p_10]}
                    onChangeText={onChangeName} value={nameValue} placeholder="Enter income description" />
            </View>
            <View>
                <Text style={common.label}>Income amount<Text style={common.c_red}>*</Text>
                </Text>
                <FakeCurrencyInput
            ...
            <View>
                <Text style={common.label}>Choose income type<Text style={common.c_red}>*</Text>
                </Text>
                <RNPickerSelect
                    placeholder={{}}
                    items={typeListItems}
