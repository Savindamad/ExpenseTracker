...
export const FixedExpense = ({ navigation }) => {
    return (
        <Stack.Navigator>
            <Stack.Screen name="ListFixedExpense" component={ListFixedExpense}
                options={{
                    headerLeft: () => (
                    ...
                    headerRight: () => (
                        <Pressable onPress={() => navigation.navigate("AddEditFixedExpense")}>
                            <Icon name="plus-circle-outline" size={30} />
                        </Pressable>
                    ),
                }} />
            <Stack.Screen name="AddEditFixedExpense" component={AddEditFixedExpense}
                options={{
                    headerLeft: () => (
                        <Pressable onPress={() => navigation.navigate("ListFixedExpense")}>
                            <Icon name="chevron-left" size={40} />
                        </Pressable>
                    ),
